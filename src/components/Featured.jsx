      ...
      <div className='px-20'>
        <div className="cards w-full flex gap-10 mt-10">
            ...
            <div className="card-container relative w-1/2 h-[75vh]">
                <h1 className='absolute text-[#CDEA68] left-full -translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] leading-nonetracking-tighter text-6xl'>{"FYDE".split("").map((item,index)=><span>{item}</span>)}</h1>
            ...
            <div className="card-container relative w-1/2 h-[75vh]">
                ...
                <h1 className='absolute text-[#CDEA68] right-full translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] leading-nonetracking-tighter text-6xl'>{"VISE".split("").map((item,index)=><span>{item}</span>)}</h1>
